...
def get_mean_trace_h5(var_name ,cvh5, delay, dur, freq):

    dt = cvh5.attrs['dt']
    var = cvh5[var_name].value
    t_start_analysis = delay + 1000.
    t_end_analysis = delay + dur
...
def fit_sin_h5(var_name ,cvh5, delay, dur, freq):
    data = get_mean_trace_h5(var_name ,cvh5, delay, dur, freq)
