...
conn_2 = dipde.Connection(int_pop, int_pop, 10, weights=-.005, delays=0.0)
...
simulation_configuration = dipde.SimulationConfiguration(dt=.0001, 
                                                         ...
                                                         checkpoint_period=.5)
network = dipde.Network(population_list=[int_pop, ext_pop], connection_list=[conn, conn_2]).to_target_network()
