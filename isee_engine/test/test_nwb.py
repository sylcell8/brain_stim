...
#     os.remove(file_name)
#     
# def test_get_stimulus():
#     t_values = np.arange(5)*.1
#     y_values = np.array([0,1,2,2,1])
#     
#     f = nwb.create_blank_file(close=False, force=True)
#     scale = nwb.Scale(t_values, 'time', 'second')
#     data = nwb.SpikeTrain(y_values, scale)
#     data.add_to_stimulus(f)
#     data.add_to_stimulus(f)
#     data = nwb.FiringRate(y_values, scale)
#     data.add_to_stimulus(f)
#     data.add_to_stimulus(f)
#     
#     nwb.get_stimulus(f)
...
def test_external_link():
    ...
    nwb.TimeSeries(data_original, scale=scale, dimension='voltage', unit='volt', metadata={'foo':1}).add_to_acquisition(f)
...
#     print 'created'
#     t0 = time.time()
#     f = nwb.create_blank_file(file_name, close=False, force=True)
#     scale = nwb.Scale(t_values, 'time', 'second')
#     data = nwb.FiringRate(y_values, scale)
#     data.add_to_stimulus(f)
...
#     round_trip = nwb.FiringRate.get_stimulus(f)
#     print 'unloaded', time.time() - t0
#     f.close()
#     file_name = f.filename
#     f.close()
#     os.remove(file_name)
