...
class Morphology(object):
    ...
    def calc_seg_coords(self):
        ...
        p05 = np.zeros((3,self.nseg)) # Fahimeh
...
#            tar_seg_prob = tar_seg_area/np.sum(tar_seg_area)    # probability of targeting segments
            ...
            self.innerv[con_key] = {'ix':tar_seg_ix, 'p' :tar_seg_prob}   # return indexes of targeted section and the corresponding probabilities
