...
if __name__ == "__main__":
    ...
    src_dir = '/data/aibstemp/antona/network/14-simulations/6-LGN_firing_rates_and_spikes/LGN_spike_trains/output'
    tgt_dir = '/data/mat/iSee_temp_shared/filters'

    convert_filters(src_dir, tgt_dir)
